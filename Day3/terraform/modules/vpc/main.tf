...
resource "aws_subnet" "public" {
  ...
  tags =  {
    Name                     = "${var.project}-pub-sn-${substr(var.availability_zones[count.index], -1, 1)}"
...
resource "aws_subnet" "private" {
  ...
  availability_zone = var.availability_zones[count.index]
  tags =  {
    Name                              = "${var.project}-priv-sn-${substr(var.availability_zones[count.index], -1, 1)}"
...
resource "aws_route_table" "private_c" {
  ...
  tags =  { Name = "${var.project}-priv-rt-c" }
}
