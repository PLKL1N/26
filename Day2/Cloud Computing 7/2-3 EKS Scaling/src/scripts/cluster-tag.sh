...
PUBLIC_A_SN_NAME="skm-public-a"
PUBLIC_C_SN_NAME="skm-public-c"
...
do
    ...
    aws ec2 create-tags --resources $name --tags Key=kubernetes.io/role/elb,Value=1 --region $REGION_CODE
done
